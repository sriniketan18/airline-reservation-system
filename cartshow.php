        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right"> 
                    <li id = "cart">
                        <a class="navbar-brand" href="cartshow.php"><span class="glyphicon glyphicon-shopping-cart"></span> Hold and Wait</a>
                    </li>                   
...
$rowcount = mysqli_num_rows($result);
    ...
    if($rowcount == 0){
        echo "<div class='alert alert-info'><strong>Nothing in the Hold and Wait list.</strong></div>";
    }
    else{
    echo "<div class='alert alert-info'>In the Hold and Wait list:</div>";
